...
<body>
			...
			<div class="row">
				...
				<div class="col-md-5">
					<div class="product-details">
						<h2 class="product-name">${order.tenSanPham}</h2>
						<div>
						...
						<div>
							<h3 class="product-price">${order.giaBan }đ</h3>
						</div>
						...
						<div class="add-to-cart">
							<div class="qty-label">
								...
								<div class="input-number">
									<input type="text" name="soLuongMua" />
								</div>
							</div>
						...
						<div class="add-to-cart">
							Họ và Tên:<br> <input class="add-to-cart-btn" name="hoVaTen" />
						</div>

						<div class="add-to-cart">
							Địa Chỉ Nhận Hàng:<br> <input class="add-to-cart-btn" name="diaChi" />
						</div>


						<a href="Success.jsp">
							<div class="add-to-cart">
								<button class="add-to-cart-btn">Xác Nhận</button>
							</div>
						</a>
	...
	<!-- /bottom footer --> </footer> <!-- /FOOTER --> <!-- jQuery Plugins --> <script
	...
	<script src="js/slick.min.js"></script> <script
		...
		src="js/jquery.zoom.min.js"></script> <script src="js/main.js"></script>
</body>
